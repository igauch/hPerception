...
<template>
    <span class="time-picker">
        ...
        <!-- 当弹出时给个全局遮罩并绑定点击事件，以达到在外面点击关闭的效果，避免了在document绑定的父作用 -->
        ...
        <div class="dropdown" v-show="showDropdown">
            <div class="select-list">
                <ul class="hours">
                  ...
                  <li v-for="hr in hours" v-text="hr" :class="{active: hour === hr}"
                      @click.stop="select('hour', hr)"></li>
                </ul>
                <ul class="minutes">
                  <li class="hint" v-text="minuteType"></li>
                  <li v-for="m in minutes" v-text="m" :class="{active: minute === m}"
                      @click.stop="select('minute', m)"></li>
                </ul>
                <ul class="seconds" v-if="secondType">
                  <li class="hint" v-text="secondType"></li>
                  <li v-for="s in seconds" v-text="s" :class="{active: second === s}"
